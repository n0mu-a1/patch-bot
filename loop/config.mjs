...
export const PROFILES = {
  reflex: makeProfile({
    game: "reflex",
    label: "瞬発ラボ",
    gameConfigFile: "examples/reflex/game-config.js",
    patchnotesFile: "examples/reflex/PATCHNOTES.md",
    decisionFile: "examples/reflex/decision.json",
    seedFile: "examples/reflex/seed-feedback.json",
  ...
  hiragana: makeProfile({
    game: "hiragana",
    label: "ひらがな おとあて",
    gameConfigFile: "examples/hiragana/game-config.js",
    patchnotesFile: "examples/hiragana/PATCHNOTES.md",
    decisionFile: "examples/hiragana/decision.json",
    seedFile: "examples/hiragana/seed-feedback.json",
